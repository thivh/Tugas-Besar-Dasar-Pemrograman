...
def uang_refund(wahana, datauser, x):
    #kondisi awal
    o = 0
    uang_refund = 0
    ketemu = False
...
def uangkembali(user,wahana,datauser,kepemilikan,refund):
    ...
    if datauser[5] == 'Pemain':
        ...
        (uangrefund, ketemu) = uang_refund(wahana,datauser,wahana_cari) #menentukan nilai variabel uangrefund
        ...
        if ketemu1 == True:
            ...
            saldo_baru = (int(datauser[6]) + (uangrefund*jmlh_tiket)) # menambahkan uang refund kepada saldo
